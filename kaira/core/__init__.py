...
Phase 5 & 7.5 modules:
- theme    — design system (Theme, Symbols, is_interactive, sym, get_banner)
- ui       — Rich output helpers (panel, kv_table, data_table, success_footer, with_summary, render_banner)
