"""Kaira deploy command group — deployment config generation and pre-flight checklist.
...
`kaira deploy run` refuses to execute if any checklist item is ❌.
"""
...
def deploy_generate(
    ...
    if platform not in _PLATFORMS:
        ...
        smart_error(
            ...
            fix_cmd="kaira deploy generate --platform railway",
            guide_topic="deploy",
        )
