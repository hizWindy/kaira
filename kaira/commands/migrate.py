...
def migrate_init() -> None:
    ...
    console.print(
        Panel(
            ...
            title="[bold]Kaira[/bold] — Migrate Init",
            border_style="cyan",
        )
    )
...
try:
    ...
    # If the models package itself cannot be imported, ignore it. Otherwise, raise.
    if e.name == "models":
        pass
    else:
        raise
...
def migrate_make(
    ...
    console.print(
        Panel(
            ...
            title="[bold]Kaira[/bold] — Migrate Make",
            border_style="cyan",
        )
    )
...
def migrate_run() -> None:
    ...
    console.print(
        Panel(
            ...
            title="[bold]Kaira[/bold] — Migrate Run",
            border_style="cyan",
        )
    )
...
def migrate_rollback() -> None:
    ...
    console.print(
        Panel(
            ...
            title="[bold]Kaira[/bold] — Migrate Rollback",
            border_style="yellow",
        )
    )
