"""DevFlow cache command group — Redis cache management and route caching.
...
def cache_init() -> None:
    ...
    console.print(
        Panel(
            ...
            "Next: [cyan]devflow event generate startup[/cyan] to register init_cache() on startup.",
            border_style="green",
        )
    )
...
def cache_status_cmd() -> None:
    ...
    table = Table(title="⚡ DevFlow — Cache Status", border_style="cyan")
