"""DevFlow event command group — FastAPI lifespan event scaffolding.
...
def event_generate(
    ...
    if event_type not in valid:
        ...
        smart_error(
            ...
            fix_cmd="devflow event generate startup",
            guide_topic="event",
        )
    ...
    if cache_on:
        ...
        console.print("  [dim]ℹ️  Cache not detected — init_cache() not included. Run devflow cache init first.[/dim]")
