"""DevFlow recap command — command history viewer."""
...
app = typer.Typer(help="Show DevFlow command history.")
...
def recap_command(
    ...
    if not history_path.exists():
        console.print(
            Panel(
                ...
                "as you run devflow commands.[/dim]",
                title="DevFlow — Recap",
                border_style="cyan",
            )
        )
    ...
    table = Table(title="⚡ DevFlow — Command History", border_style="cyan")
