...
def test_run() -> None:
    ...
    cmd = [sys.executable, "-m", "pytest", "tests/", "--cov=.", "--cov-report=term-missing"]
    ...
    if cov_lines:
        table = Table(title="DevFlow — Test Coverage Report", border_style="cyan")
        # Header
